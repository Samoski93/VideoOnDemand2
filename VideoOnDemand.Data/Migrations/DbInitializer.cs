...
namespace VideoOnDemand.Data.Migrations
{
    ...
    {
        // To have some data to work with when the tables have been created, you will add seed data to them when they have been created.

        // This method is called when the database needs to be recreated after each migration
        ...
        public static void Initialize(VODContext context)
        {
            ...
            var email = "samoski93@hotmail.com";
